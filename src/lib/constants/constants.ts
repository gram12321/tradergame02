...
type CustomerTypeConfig = {
  priceMultiplierRange: readonly [number, number];
  quantityRange: readonly [number, number];
  baseQuantityMultiplier: number;
  multipleOrderPenalty: number;
  difficultyPreference: DifficultyPreference;
};

const CUSTOMER_TYPE_CONFIGS: Record<CustomerType, CustomerTypeConfig> = {
  'Restaurant': {
...
export const SALES_CONSTANTS = {
  ...
  CUSTOMER_TYPES: CUSTOMER_TYPE_CONFIGS,
